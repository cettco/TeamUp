...
<html>
  ...
  System.out.println("main1");
   while(set.next())
   {
	   ...
	   String favGroup = set.getString("Group");
	   System.out.println(favGroup);
	   System.out.println("main3");
	   String sql2 = "select * from team_info where Type='"+favGroup+"'";
	   System.out.println("main4");
	   try{rs = statement.executeQuery(sql2);
	   ...
	   while(rs.next())
	   {
           ...
           String content = rs.getString("Introduction");
		   %>
           <hr>
                <h3><%=favGroup %></h3>
            <hr>
           <article>
              <h2><a href="detail.jsp?author=<%=author%>&topic=<%=topic%>&group=<%=favGroup%>"><%=topic %></a></h2><br>
